...
```bash
wget https://github.com/kerlannXmr/Easynode_traffic_obfuscation/releases/download/v6/easynode_traffic_obfuscation.sh -O easynode_traffic_obfuscation.sh && chmod +x easynode_traffic_obfuscation.sh && sudo ./easynode_traffic_obfuscation.sh
```

- Normal users: copy&paste in new terminal

```bash
sudo wget -P ~ https://github.com/kerlannXmr/Easynode_traffic_obfuscation/releases/download/v6/easynode_traffic_obfuscation.sh
```
